...
require_file_text "$fedora_spec" "%global         module_host_version 0.1.2"
...
require_file_text "$host_fetcher" "host_version=0.1.2"
require_file_text "$host_fetcher" "9bb6a9ad524a302032e44ead67ef2541cd36d786d9322a03a4ac2ba84a9994f8"
require_file_text "$host_fetcher" "e86423363a104077f5c101fc29cd1476fd3c1ed626fe271a4ed0bf293912e155"
